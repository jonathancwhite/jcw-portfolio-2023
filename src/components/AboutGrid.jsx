				...
				<div className='grid__row xlgrid'>
					...
					<div className='col filled gridText'>
						<p className='aboutText'>
							...
							development, and I love getting hands-on. I&apos;m a
							multidisciplinary jack-of-all-trades, with a skill
							set that ranges from conceptual thinking to creating
